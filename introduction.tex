...
\begin{itemize}
    ...
    \item develop a method for measuring the quality of partitioning variables based on a randomized, non-parametric permutation test which allows us to incorporate a wide range of existing cognostics for single visualizations, while adjusting for their pattern detection sensitivitiesœ, and
...
The next section summarizes related work on small multiples, cognostics, and non-parametric approaches in visualization. This is followed by a description of our method for ranking small multiple displays. Then, we validate how our method complies with the set of goodness criteria for these displays. Finally, we discuss future work and draw conclusions from this research.
